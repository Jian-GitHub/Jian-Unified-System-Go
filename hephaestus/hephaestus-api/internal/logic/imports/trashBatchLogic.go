...
func (l *TrashBatchLogic) TrashBatch(req *types.TrashBatchReq) (resp *types.Batch, err error) {
	in, e := access.Request[income.TrashBatchRequest](l.ctx, req)
	if e != nil {
		return nil, e
	}
	v, e := l.svcCtx.Imports.TrashBatch(l.ctx, in)
	if e != nil {
		return nil, e
	}
