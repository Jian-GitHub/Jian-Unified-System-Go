...
func (l *ArchiveRecordLogic) ArchiveRecord(in *income.ArchiveRecordRequest) (*income.Record, error) {
	if in.Input == nil {
	...
	v, e := l.svcCtx.App.Mutate(l.ctx, in.OwnerId, id, in.ExpectedVersion, in.IdempotencyKey, "archived", "", "", nil)
